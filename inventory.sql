...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2018 at 06:11 PM
...
(1, 'UBANTE Digit', 'Electronic Micrometer with Large Display - Inch / Metric Conversion 0-1 ', 25, 58, 10, '71VLS3YbclL._SL1500_.jpg'),
(2, 'Directional Control Valv', 'Prince RD522CCAA5A4B1 Directional Control Valve, Two Spool, 4 Ways, 3 Positions, Tandem Center, Cast Iron, 3000 psi, Lever Handle, 25 gpm, In/Out: 3/4', 26, 200.99, 10, '81H7wwjsL-L._SL1500_.jpg'),
...
(8, 'Binocular', 'Optics Vanquish 10x26 Reverse Porro Prism Binocular. ... Bushnell Legend Ultra HD Compact Waterproof Binoculars 10x26. ', 7, 67.4, 10, 'binocular.jpg'),
(9, 'Graduated Cylinders', 'Scientific Glass Graduated Cylinder measuring cylinder 10ml 25ml 50ml 100ml. ... 4pcs Clear Measuring Plastic Graduated Cylinder Cup 10ml / 25ml / 50ml / 100ml. ... 4 PIXNOR Transparent Measuring Plastic Graduated Cylinder 10ml / 25ml / 50ml / 100ml.', 9, 3.4, 10, 'Graduated Cylinders.jpg'),
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
